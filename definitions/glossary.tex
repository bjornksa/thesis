...
\newacronym{osf}{OSF}{Operational Space Formulation}
\newacronym{srmtp}{SRMTP}{singularity robust multiple task priority}
...
\newacronym{mgc}{MGC}{Motion Gyro Compass}
\newacronym{imu}{IMU}{inertial measurement unit}
\newacronym{gps}{GPS}{global positioning system}
\newacronym{dvl}{DVL}{Doppler velocity log}
\newacronym{usbl}{USBL}{ultra-short baseline}
